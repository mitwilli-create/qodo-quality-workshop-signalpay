...
code. No hosted-review rules or integrations are used.
...
The repo-local rules are the complete source of truth for planning, coding, and
review. This keeps the workshop deterministic and free of provider billing.
...
6. Record any skipped local check and why it was skipped.
...
## How Rules and Skills Fit Together
...
| Local review skill | `skills/` | A second perspective on correctness, security, quality, and contract compliance. |

Report only the local rules, skills, commands, and review evidence that actually
ran. Hosted-review coverage is outside this workshop's policy.
...
| `PAY-005` | Public application programming interface (API) responses use stable camelCase JSON fields | [api-and-events.md](api-and-events.md) |
...
| `PAY-008` | Hosted-review credentials and local secrets must never be added | [secrets-and-workshop-safety.md](secrets-and-workshop-safety.md) |
...
| Configure local agents | `PAY-008`, `PAY-009` |
...
Hosted review:
- Not used. Qodo and Greptile are blocked.
